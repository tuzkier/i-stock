...
- section `## Agent 实现` in `harness-runtime/harness/artifacts/*/technical-analysis/tech-design.md`
- section `## Agent 架构` in `harness-runtime/harness/artifacts/*/solution/solution.md`
