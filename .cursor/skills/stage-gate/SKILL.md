...
def main() -> int:
    ...
    payload = {
        ...
        "artifacts": {
            "stage_artifact": args.stage_artifact or contract_check.get("stage_artifact"),
            "contract_artifact": args.contract_artifact or contract_check.get("contract_artifact") or contract_check.get("artifact"),
        },
    ...
    out_dir = output_dir / args.mission_id
