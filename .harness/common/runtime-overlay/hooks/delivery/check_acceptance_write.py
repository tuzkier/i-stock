...
2. If verification-report.contract.yaml is readable, verify gate must be PASS
   (i.e. contract must not be completely empty / missing acceptance_trace).
"""
...
def main() -> int:
    ...
    # Soft check: if verification-report contract is present, ensure it has acceptance_trace.
