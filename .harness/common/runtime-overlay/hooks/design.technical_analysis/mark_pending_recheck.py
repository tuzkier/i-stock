#!/usr/bin/env python3
"""Stage-4 design+technical_analysis PostToolUse hook: set
tech-design.contract.yaml pending_reviewer_recheck=true after any
tech-design.md edit.
...
_TECH_DESIGN_PATH_RE = re.compile(r"harness-runtime/harness/stages/([^/]+)/tech-design\.md$")


def _extract_mission(path: str) -> str | None:
    match = _TECH_DESIGN_PATH_RE.search(path.replace("\\", "/"))
