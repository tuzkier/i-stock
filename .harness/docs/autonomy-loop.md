...
| `breakdown` | `breakdown` | `execution-brief.md` |
| `execute` | `execute` | 代码变更与 `execution-result.md` |
| `code-review` | `code-review` / `agent-eval` | review evidence |
| `verify` | `verify` | verification evidence |
