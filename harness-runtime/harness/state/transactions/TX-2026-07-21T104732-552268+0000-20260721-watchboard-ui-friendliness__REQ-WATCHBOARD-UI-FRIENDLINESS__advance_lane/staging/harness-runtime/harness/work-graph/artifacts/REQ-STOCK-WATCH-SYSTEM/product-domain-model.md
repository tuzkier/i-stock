...
| EXC-08 | 布局快照损坏 | CMD-13 | 回到默认 dense 或设备等价默认 | 重复恢复不破坏状态 | BUC-07 |
...
|---|---|---|---|
| interaction | 归一预览、自选摘要、三栏工作台、MTS 卡、提醒 taxonomy、来源健康、dense/focus/mobile_tab | BUC-01~BUC-08, BO-001~BO-008 | 需要重新对齐旧 interaction 产物 |
