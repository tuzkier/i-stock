...
description: "Use when the user wants to review a pull request, understand what a PR changes, assess merge risk, or check for missing test coverage. Examples: \"Review this PR\", \"What does PR #42 change?\", \"Is this PR safe to merge?\""
---
...
- 审查ing someone else's code changes before 合并
...
> If "Index is stale" → run `npx gitnexus analyze` in terminal before 审查ing.
