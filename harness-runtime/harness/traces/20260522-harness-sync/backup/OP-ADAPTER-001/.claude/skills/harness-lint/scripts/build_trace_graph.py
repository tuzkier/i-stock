...
ID_PATTERN = re.compile(r"\b(AC-[A-Za-z0-9-]+|FR-[A-Za-z0-9-]+|NFR-[A-Za-z0-9-]+|REQ-[A-Za-z0-9-]+|SCN-[A-Za-z0-9-]+|DEC-[A-Za-z0-9-]+|MOD-[A-Za-z0-9-]+|IF-[A-Za-z0-9-]+|DATA-[A-Za-z0-9-]+|VS-[A-Za-z0-9-]+|T-?\d+|EV-[A-Za-z0-9-]+|CMD-[A-Za-z0-9-]+|FND-[A-Za-z0-9-]+|MEM-[A-Za-z0-9-]+)\b")
