...
description: '当 git-workflow close 在 retrospective PASS 后委托分支收尾时使用。用户说"分支怎么处理""合并代码""收尾"时，自治循环先路由到 git-workflow close。'
---
...
- `retrospective` Stage Gate PASS 后，自治循环调度 `git-workflow close`
