...
(0, node_test_1.describe)("watchlist localStorage replay", () => {
    ...
    (0, node_test_1.it)("keeps legacy disabled alerts disabled during replay", () => {
        ...
        strict_1.default.equal(replayedAlerts[0].enabled, false);
        strict_1.default.equal(replayedAlerts[0].activationState, "disabled");
    });
});
