...
export function cleanTickerInput(symbol) {
    return symbol.trim().toUpperCase().replace(/\s+/g, "");
}
export function normalizeTickerForMarket(symbol, market) {
...
export function buildNormalizationPreview(rawInput, selectedMarket, watchlist) {
