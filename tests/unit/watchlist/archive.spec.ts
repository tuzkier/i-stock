...
import {
  archiveWatchSymbol,
  restoreAlertsForActiveSymbol,
  restoreWatchSymbol,
  suspendAlertsForArchivedSymbol
} from "../../../src/domain/watchlist-state.js";
import type { AlertRule, WatchSymbol } from "../../../src/types.js";

const watchlist: WatchSymbol[] = [{ id: "9988.HK", symbol: "9988.HK", name: "阿里巴巴", market: "HK", status: "active" }];
